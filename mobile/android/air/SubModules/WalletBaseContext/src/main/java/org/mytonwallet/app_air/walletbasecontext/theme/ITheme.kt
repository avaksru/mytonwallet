...
const val DEFAULT_TINT_LIGHT = 0xFF2481CC.toInt()
const val DEFAULT_TINT_DARK = 0xFF5BA0E0.toInt()
...
internal val THEME_LIGHT_PRESET
    get() = create(
        mapOf(
            ...
            WColor.PrimaryDarkText to 0xFF3C3C43.toInt(),
            ...
            WColor.Decimals to 0xFFC7C7CC.toInt(),
            WColor.Tint to DEFAULT_TINT_LIGHT,
            WColor.TextOnTint to 0xFFFFFFFF.toInt(),
            WColor.SecondaryTextOnTint to 0xBFFFFFFF.toInt(),
            WColor.Separator to 0x143C3C43,
            WColor.SecondaryBackground to 0xFFF5F5F5.toInt(),
            WColor.TrinaryBackground to 0xFFF5F5F5.toInt(),
            ...
            WColor.Green to 0xFF1E7E34.toInt(),
            ...
            WColor.Icon to 0xFF8E8E93.toInt()
        )
    )
...
internal val THEME_DARK_PRESET
    get() = create(
        mapOf(
            WColor.Background to 0xFF1C1C1E.toInt(),
            WColor.PrimaryText to 0xFFFFFFFF.toInt(),
            WColor.PrimaryDarkText to 0xFFB0B0B8.toInt(),
            WColor.PrimaryLightText to 0xFF8E8E93.toInt(),
            WColor.SecondaryText to 0xFF8E8E93.toInt(),
            WColor.SubtitleText to 0xFF8E8E93.toInt(),
            WColor.Decimals to 0xFF55555A.toInt(),
            WColor.Tint to DEFAULT_TINT_DARK,
            WColor.TextOnTint to 0xFFFFFFFF.toInt(),
            WColor.SecondaryTextOnTint to 0xBFFFFFFF.toInt(),
            WColor.Separator to 0x59545458,
            WColor.SecondaryBackground to 0xFF1C1C1E.toInt(),
            WColor.TrinaryBackground to 0xFF2C2C2E.toInt(),
            ...
            WColor.DIVIDER to 0xFF8E8E93.toInt(),
            WColor.Error to 0xFFFF3B30.toInt(),
            WColor.Green to 0xFF34C759.toInt(),
            WColor.PositiveBalance to 0xFF7BFF9D.toInt(),
            WColor.Red to 0xFFFF453A.toInt(),
            WColor.Buy to 0xFF49CA3B.toInt(),
            WColor.Sell to 0xFFFF5148.toInt(),
            WColor.Purple to 0xFF7D88F4.toInt(),
            WColor.Orange to 0xFFFF9F0A.toInt(),
            WColor.StockBadge to 0xFFDE8C00.toInt(),
            WColor.EarnGradientLeft to 0xFF41C433.toInt(),
            WColor.EarnGradientRight to 0xFF5BA0E0.toInt(),
            ...
            WColor.SearchFieldBackground to 0xFF1C1C1E.toInt(),
            WColor.Transparent to 0x00000000,
            WColor.White to 0xFFFFFFFF.toInt(),
            WColor.Black to 0xFF000000.toInt(),
